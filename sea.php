...
<nav id="mainnav">
	...
	<div class="panel">
		<ul>
			...
			<li><a href="./#sec02">SEA</a></li>
			<li><a href="./#sec03">NIU</a></li>
			<li><a href="./#sec04">TOKYO</a></li>
...
<article>
	<a href="#">
		<img src="images/test.jpg"alt="" class="icon">
		<div class="dd">
			<div class="date">2022年1月19日</div>
			<div class="title">タイトル</div>
			<div class="text">本文の前半を少しだけ表示</div>
		</div>
	</a>
</article>
-->
